    ...
    "paths": {
        ...
        "/testGame/createTestGame": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建TestGame",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.TestGame"
                        }
                    }
                ],
                "responses": {
        ...
        "/testGame/getTestGameList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取TestGame列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.TestGameSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/testTp/createTestTp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建TestTp",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.TestTp"
                        }
                    }
                ],
                "responses": {
        ...
        "/testTp/getTestTpList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取TestTp列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.TestTpSearch"
                        }
                    }
                ],
                "responses": {
